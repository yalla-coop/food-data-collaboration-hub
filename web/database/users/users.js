...
export async function replaceRefreshToken(id, obtainNewTokensIfNecessary) {
    ...
    try {
        ...
        const result = await client.query(`SELECT pgp_sym_decrypt(refresh_token::bytea, $2) as "refreshToken", pgp_sym_decrypt(access_token::bytea, $2) as "accessToken", access_token_expires_at as "access_token_expires_at" from users where user_id = $1 FOR UPDATE`,
         [id, encryptionKey])
